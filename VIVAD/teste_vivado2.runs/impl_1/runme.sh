...
HD_PWD='C:/Users/renan/Desktop/teste_vivado2/teste_vivado2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nmp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nmp_wrapper.tcl -notrace
