...
HLS_SOURCES = ../../../../nmp_axi4l_ip_tb.cpp ../../../../bram.cpp ../../../../nmp_axi4l_ip.cpp
...
$(ObjDir)/nmp_axi4l_ip_tb.o: ../../../../nmp_axi4l_ip_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../nmp_axi4l_ip_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/nmp_axi4l_ip_tb.d

$(ObjDir)/bram.o: ../../../../bram.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../bram.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/bram.d

$(ObjDir)/nmp_axi4l_ip.o: ../../../../nmp_axi4l_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../nmp_axi4l_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/nmp_axi4l_ip.d
