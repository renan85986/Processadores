...
#(parameter
    ...
    input  wire                          clk,
    input  wire                          rst,
    output wire [7:0]                    awaddr_x,
    output wire [0:0]                    awvalid_x,
    output wire [0:0]                    awready_i,
    input  wire [0:0]                    awready_o,
    input  wire                          awready_o_ap_vld,
    output wire [31:0]                   wdata_x,
    output wire [0:0]                    wvalid_x,
...
localparam
    ...
    ADDR_BREADY_DATA_0    = 8'h60,
    ADDR_BREADY_CTRL      = 8'h64,
    ADDR_ARADDR_DATA_0    = 8'h68,
    ADDR_ARADDR_CTRL      = 8'h6c,
    ADDR_ARVALID_DATA_0   = 8'h70,
    ADDR_ARVALID_CTRL     = 8'h74,
    ADDR_ARREADY_I_DATA_0 = 8'h78,
    ADDR_ARREADY_I_CTRL   = 8'h7c,
    ADDR_ARREADY_O_DATA_0 = 8'h80,
    ADDR_ARREADY_O_CTRL   = 8'h84,
    ADDR_RDATA_DATA_0     = 8'h88,
    ADDR_RDATA_CTRL       = 8'h8c,
    ADDR_RVALID_I_DATA_0  = 8'h98,
    ADDR_RVALID_I_CTRL    = 8'h9c,
    ADDR_RVALID_O_DATA_0  = 8'ha0,
    ADDR_RVALID_O_CTRL    = 8'ha4,
    ADDR_RREADY_DATA_0    = 8'ha8,
    ADDR_RREADY_CTRL      = 8'hac,
    ADDR_RST_N_DATA_0     = 8'hb8,
    ADDR_RST_N_CTRL       = 8'hbc,
    WRIDLE                = 2'd0,
    WRDATA                = 2'd1,
    WRRESP                = 2'd2,
    WRRESET               = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [0:0]                    int_bready = 'b0;
    reg  [0:0]                    bready_set = 'b0;
    ...
    reg  [0:0]                    int_rready = 'b0;
    reg  [0:0]                    rready_set = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_BREADY_DATA_0: begin
                    rdata <= bready_set[0:0];
                end
                ...
                ADDR_RREADY_DATA_0: begin
                    rdata <= rready_set[0:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_BREADY_DATA_0)
            bready_set[0:0] <= (WDATA[31:0] & wmask) | (bready_set[0:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_RREADY_DATA_0)
            rready_set[0:0] <= (WDATA[31:0] & wmask) | (rready_set[0:0] & ~wmask);
    end
end
