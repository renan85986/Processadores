...
HD_PWD='C:/Users/renan/Desktop/teste_vivado2/teste_vivado2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nmp_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nmp_wrapper.tcl
